...
//! commit rather than the release-wide `0.3.0` that every build shares.

/// The crate version from `Cargo.toml` (`0.3.0`).
...
/// Version and commit together, e.g. `0.3.0 (3e0e567)` — what `--version`
/// prints.
...
mod tests {
    ...
    fn git_is_never_empty() {
        // An empty commit field would render as `0.3.0 ()`, which looks like a
